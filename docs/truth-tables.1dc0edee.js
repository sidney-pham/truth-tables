...
},{"./isNode":56}],27:[function(require,module,exports) {
'use strict';
...
},{"./camelize":48}],13:[function(require,module,exports) {
/** @license React v16.4.2
...
},{"fbjs/lib/invariant":19,"react":6,"fbjs/lib/warning":20,"fbjs/lib/ExecutionEnvironment":24,"object-assign":18,"fbjs/lib/emptyFunction":22,"prop-types/checkPropTypes":23,"fbjs/lib/getActiveElement":25,"fbjs/lib/shallowEqual":26,"fbjs/lib/containsNode":27,"fbjs/lib/emptyObject":21,"fbjs/lib/hyphenateStyleName":29,"fbjs/lib/camelizeStyleName":28}],7:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react-dom.development.js":13}],55:[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":55}],16:[function(require,module,exports) {
...
function parse(input) {
  ...
  try {
    for (var _iterator = input[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      var isVariable = !isOperator(token) && !isParen(token);
      if (isVariable) {
        queue.push(token);
        ...
        while (!(stack.empty() || stack.peek() === '(') && getPrecedence(stack.peek()) > getPrecedence(token)) {
...
function getVariables(parsedInput) {
  ...
  try {
    for (var _iterator3 = parsedInput[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
...
function getTruthAssignments(variables) {
  var truthAssignments = [];
  if (variables.length !== 0) {
    var f = function f(truths, done) {
...
function evaluate(formula, truthValues) {
  ...
  try {
    for (var _iterator4 = formula[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
...
var TruthTable = function (_React$Component) {
  _inherits(TruthTable, _React$Component);

  function TruthTable(props) {
    _classCallCheck(this, TruthTable);

    var _this = _possibleConstructorReturn(this, (TruthTable.__proto__ || Object.getPrototypeOf(TruthTable)).call(this, props));
    ...
    value: function render() {
      ...
      try {
        ...
        return _react2.default.createElement(
          'table',
          { className: _style2.default.truthTable },
          ...
          _react2.default.createElement(
            'tbody',
            null,
            truthAssignments.map(function (truthAssignment, index) {
              return _react2.default.createElement(
                'tr',
                { key: index },
                variables.map(function (variable) {
                  return _react2.default.createElement(
                    'td',
                    { key: variable },
                    truthAssignment[variable] ? TRUE : FALSE
                  );
                }),
                _react2.default.createElement(
                  'td',
                  null,
                  (0, _helpers.evaluate)(parsedFormula, truthAssignment) ? TRUE : FALSE
                )
              );
            })
          )
...
},{"react":6,"./style.css":53,"./helpers":54}],52:[function(require,module,exports) {

var reloadCSS = require('_css_loader');
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
module.exports = {
        "modal": "_modal_f57ho_1",
        "open": "_open_f57ho_13",
        "closed": "_closed_f57ho_18",
        "content": "_content_f57ho_22",
        "topBar": "_topBar_f57ho_45",
        "shadow": "_shadow_f57ho_57",
        "closeButton": "_closeButton_f57ho_61",
        "modalContent": "_modalContent_f57ho_76",
        "header": "_header_f57ho_81",
        "operatorTable": "_operatorTable_f57ho_85"
};
},{"_css_loader":51}],42:[function(require,module,exports) {
'use strict';
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'p',
              null,
              'Ties are broken by order, with operators further to the right in the formula having higher precedence.'
            ),
            _react2.default.createElement(
              'h3',
              null,
...
},{"react":6,"./style.css":52}],10:[function(require,module,exports) {
'use strict';
...
var _truthTable = require('../truth-table');

var _truthTable2 = _interopRequireDefault(_truthTable);

var _helpModal = require('../help-modal');
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'button',
            { type: 'button', className: _style2.default.helpButton, onClick: this.toggleModal, title: 'Help' },
            _react2.default.createElement('i', { className: 'far fa-question-circle' })
          ),
          _react2.default.createElement(
            'p',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'a',
            { href: 'https://github.com/sidney-pham/truth-tables' },
            _react2.default.createElement('i', { className: 'fab fa-github', title: 'sidney-pham' })
          )
        )
      );
    }
...
exports.default = App;
},{"react":6,"./style.css":16,"../truth-table":43,"../help-modal":42}],4:[function(require,module,exports) {
'use strict';
...
},{"react":6,"react-dom":7,"./components/app":10}],35:[function(require,module,exports) {
...
//# sourceMappingURL=truth-tables.1dc0edee.map